...
* `data/bgen/ghana_2015_study_1555_samples.bgen` and
* `data/vcf/ghana_2015_study_1555_samples.vcf.gz`

For PC computation, I also created a 'fakediploid' version of the vcf file in `data/vcf/ghana_2015_study_1555_samples.fakediploid.vcf.gz`.  This makes all samples diploid with homozygous genotypes, and is so that the `qctool -kinship` option works.
...
The code also uses `qctool` and `hptest` which can be obtained from:

* [QCTOOL website](https://www.chg.ox.ac.uk/~gav/qctool/)
* [HPTEST website](https://www.chg.ox.ac.uk/~gav/hptest/)
...
system(
	paste(
		"qctool_v2.2.1",
		"-g data/vcf/ghana_2015_study_1555_samples.fakediploid.vcf.gz",
		"-s data/samples/ghana_2015_study_1555_samples.sample",
		"-excl-samples-where 'pf7_QC_pass=FALSE'",
		"-excl-samples-where 'eurofins_final_called=FALSE'",
